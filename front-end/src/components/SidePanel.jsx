...
export default function SidePanel ({smallScreen, setShowLogin, loggedInUser, allResumes, setLoggedInUser, setCurrResumeData})  {
    ...
    if (!smallScreen) {
        ...
        return (
            <div>
                ...
                <button
                onClick = {() => setIt(true)}
                className = {`bg-violet-300 shadow-[0_0_5px_1px_rgba(0,0,0,0.25)] fixed z-40 top-2 left-2 h-[10vh] w-[10vh] rounded-full`}>
